...
public class Transition_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.indent();
    tgs.append("S_");
    tgs.append(SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.nextState$7qSt), LINKS.target$T1NS), PROPS.name$MnvL));
    tgs.append("();");
    tgs.append("break;\n");
